...
class OptimizationConfig(BaseModel):
    ...
    remote_nodes: Union[None,list[Tuple[IPv4Address, int]]] = \
        Field(example=[["192.168.178.2",12345], ["192.168.178.65",12345], ["192.168.178.96",12345]], description="IP addresses and port of the remote nodes used to test the model")
